...
<div class="profiel-container">
    <div class="logo-container">
        <div class="profiel-logo"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="#fff" class="bi bi-person" viewBox="0 0 16 16">
    ...
    <div class="info-container">
        <form action="/profiel" method="post">
            ...
            <div class="profile-email">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-at" viewBox="0 0 16 16">
            ...
            <!--<label>Email:</label>
            <input type="email" name="email" value=" // htmlspecialchars($user->getEmail()) ?>"><br>
